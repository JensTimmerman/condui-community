...
import { getFloorPlanFromProject } from '@/lib/projectV2/buildingFloors'
...
const PlanFloorOverlaySingle = memo(function PlanFloorOverlaySingle({
  ...
  const floor = useProjectStore((s: ProjectState) => s.getFloorById(floorId) ?? null)
  ...
  const fp = currentProject ? getFloorPlanFromProject(currentProject, floorId) : floor.floorPlan
